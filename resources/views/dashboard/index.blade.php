    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <h2 class="display-5 fw-bold mb-3" data-aos="fade-down">Jaringan <span class="text-warning">13 CCTV</span> Kuningan</h2>
                    ...
                    <div class="card cctv-card h-100 border-0 shadow-sm">
                        <div class="card-header bg-warning text-dark py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0 fw-bold">CCTV {{ sprintf('%02d', $i) }}</h5>
                                <i class='bx bx-cctv fs-4'></i>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="text-primary mb-2">Lokasi Strategis {{ $i }}</h6>
                ...
                <div class="bg-white rounded-3 p-4 shadow-sm">
                    <div class="row text-center">
                        <div class="col-md-3 mb-3">
                            <div class="display-6 fw-bold text-warning">13</div>
                            <div class="text-muted">Total CCTV</div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="display-6 fw-bold text-success">13</div>
