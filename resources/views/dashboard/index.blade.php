    ...
    <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
            <div class="col-md-10 text-center" data-aos="fade-up">
                ...
                <p class="hero-subtitle text-white">Sistem Monitoring CCTV Terintegrasi untuk Keamanan dan Transparansi</p>
                <div class="hero-divider"></div>
            </div>
        </div>
    </div>
    
    <a class="mouse smoothscroll mb-5" href="#next">
    ...
    <div class="container">
        <div class="row check-availabilty" id="next">
            <div class="col-12 text-center" data-aos="fade-down">
                <h4 class="fw-bold text-white" style="font-family: 'Poppins', 'Segoe UI', Arial, sans-serif;">
            ...
            <div class="row g-3 justify-content-center align-items-center">
                <div class="col-md-5 col-lg-4" data-aos="fade-right">
                    <a href="#section-peta" type="button" class="btn btn-warning btn-outline-light btn-hover w-100 p-3 d-flex align-items-center justify-content-center shadow text-decoration-none">
                ...
                <div class="col-md-5 col-lg-4" data-aos="fade-left">
                    <a href="#section-live" type="button" class="btn btn-primary btn-outline-light btn-hover w-100 p-3 d-flex align-items-center justify-content-center shadow text-decoration-none">
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-md-12 col-lg-6 order-lg-1" data-aos="fade-right">
                ...
                <p class="text-muted mb-4">
                    Dengan <strong class="text-warning">{{ count($cameras) }} kamera canggih</strong> yang tersebar di lokasi strategis, 
                    ...
                    <div class="cctv-scroll-item camera-status" data-slug="{{ $data->slug }}">
                        <div class="card cctv-card h-100 border-0 shadow">
                            ...
                            <div class="card-footer bg-transparent border-0 pt-0">
                                <button class="btn btn-primary btn-sm w-100 fw-semibold" onclick="showCameraModal({{ $data->id }})">
...
// Show camera modal (implement based on your needs)
function showCameraModal(cameraId) {
    // Implement your modal logic here
    $('#locationModal').modal('show');
    $('#locationDetails').html('<div class="loading-spinner"></div>');
    
    // Example: load camera details via AJAX
    // $.get(`/dashboard/cameras/${cameraId}`, function(data) {
